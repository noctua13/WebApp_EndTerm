...
<div style="padding-left:10px; padding-right:10px; padding-top:10px;" class="row">
	...
	<div class="col-md-10 col-xl-10">
		<div style=" padding:10px 10px 10px 10px; background-color: rgba(255, 255, 255, 0.75);" class="col-md-12 white">
			...
			<hr />
			<a ><image style="width: 33%;" src="./assets/yIEypXX1.png" /></a><br><br>
			<a ><image style="width: 33%;" src="./assets/D8hINI_UIAER6ao.jpg" /></a><br><br>
			<a ><image style="width: 33%;" src="./assets/D9FLUFWUwAE_LhE.png" /></a><br><br>
		</div>
	</div>
</div>
<!-- Bottom Page -->
