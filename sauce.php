    ...
    <div id="icetab-content">
        ...
        <div class="tabcontent">
        	...
        	<div>
				...
				<br>
				<button type="button" disabled class="btnTinh" id="btnX">Cal</button>
        ...
        <div class="tabcontent">
        	...
        	<input style="width:100px ;height: 20px ;margin-top: 3px;margin-left: 200px; position: absolute;" type="number" id="txtAa" step="0.001" min="5.000" max="35.000"><b>Rune mana</b><br>
				...
				<br>
				<button type="button" disabled class="btnTinha" id="btnXa">Cal</button>
				...
				<button type="button" disabled class="btnTinhb" id="btnXb">Cal</button>
